...
function getRepos(username) {
  return axios.get(`https://api.github.com/users/${username}/repos?per_page=100`).then((user) => user.data)
}   
...
export { FetchPopularRepos, BattleService }